...
maxd <- as.Date("2022-10-19", tz = "Etc/GMT-2")

raw_data_dir <- "/scratch/project_2003061/microclim/hyytiala2022"
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-25")))
probls <- c(as_date(as_date("2021-10-12"):as_date("2022-10-18")))
hattu <- c()
...
probls <- c(as_date(as_date("2020-04-25"):as_date("2020-10-27")),
            as_date(as_date("2022-07-23"):as_date("2022-10-18")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-25")))
probls <- c()
hattu <- c(as_date(as_date("2022-09-01"):as_date("2022-10-18")))
